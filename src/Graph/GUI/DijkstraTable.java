...
public class DijkstraTable extends javax.swing.JFrame {
    ...
    /**
     * Creates new form DisjktraTable
     */
    ...
    private void initComponents() {
        ...
        jTable1.setBackground(new java.awt.Color(18, 47, 63));
        jTable1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(18, 47, 63)));
        ...
        jTable1.setGridColor(new java.awt.Color(18, 47, 63));
        jTable1.setSelectionForeground(new java.awt.Color(255, 255, 255));
        jScrollPane1.setViewportView(jTable1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 100, 460, 220));
        ...
        jLabel3.setText("Resultados del algoritmo DIsjktra");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 40, 190, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DijkstraTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DijkstraTable().setVisible(true);
            }
        });
    }
    public void solution(String nodeOne, String nodeTwo) { 
